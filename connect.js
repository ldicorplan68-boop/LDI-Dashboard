...
// Usage: include <script src="connect.js"></script> before any script that
// needs HOSTNAME or ANON_KEY.
// ============================================================================

const HOSTNAME  = 'https://trainers-police-rome-amplifier.trycloudflare.com';
...
// expose on window so inline scripts can read them
